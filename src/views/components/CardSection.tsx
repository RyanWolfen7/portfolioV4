...
const CardSection = ({
    ...
    return (
        <section 
            id={target} 
            class="trigger mb-16 scroll-mt-16 md:mb-24 lg:mb-48 lg:scroll-mt-24" 
            aria-label={text}
        >
            ...
            <div
                class="relative top-96 min-w-full bg-accent-100 opacity-50"
                hx-post={`/nav/${target}`}
                hx-target="#nav"
            ...
            <div
                ...
                hx-trigger={`intersect threshold:0.3`}
                hx-swap="innerHTML"
                hx-sync={"#nav:que"}
            />
